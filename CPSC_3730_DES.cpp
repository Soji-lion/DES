...
string encryption(string plainText, string key, int choice)
{
...
string result = "";
if (choice==1){
    result = encrypt(plainText, rkb, rk);
} else if (choice == 2){
...
int main() 
{
    ...
    if (choice == 1) 
    {
        ...
        cin >> key;
        cout << "Enter the plain text in hexadecimal format: ";
        cin >> plainText;

        cipherText = encryption(plainText, key, choice);

        cout << "The encrypted message (in hexadecimal): " << cipherText << endl;
    } 
    else if (choice == 2) 
    {
        cout << "Enter the key in hexadecimal format: ";
        cin >> key;
        cout << "Enter the cipher text in hexadecimal format: ";
        cin >> cipherText;

        plainText = encryption(cipherText, key, choice);

        cout << "The decrypted message (in hexadecimal): " << plainText << endl;
    } 
    else 
    {
